...
async def create_serving() -> models.ServingSize:
    serving = {
        ...
        "carbs": 750,
        "protein": 372,
        "food": {"id": 1, "category_id": 2, "type": 'posuere', "subtype": 'viverra dapibus', "profile_id": 1}
    } 
    return serving
...
async def get_serving() -> models.ServingSize:
    ...
    food = {"id": 13, "category_id": 6, "type": 'fermentum justo nec', "subtype": None, "profile_id": 1}
...
async def update_serving() -> models.ServingSize:
    ...
    food = {"id": 17, "category_id": 3, "type": 'nec sem', "subtype": 'magna', "profile_id": 1}
    return {**serving, 'food':food}
