...
#     status_code=status.HTTP_200_OK,
# )
# def get_user(*, request: Request, user_id:int, db: Session = Depends(deps.get_db)):
...
# )
# def post_user(*, request: Request, User: schemas.UserCreate, db: Session = Depends(deps.get_db)):
...
# status_code=status.HTTP_201_CREATED,
# )
# def get_foods_brand(*, request: Request, search_for:str, search_word:str, db: Session = Depends(deps.get_db)):
